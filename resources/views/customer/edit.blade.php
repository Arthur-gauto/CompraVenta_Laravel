                    ...
                    <div class="container mt-4">
                        ...
                        <form action="{{ route('customers.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="ruc" class="form-control" id="ruc" value="{{ $customer->ruc }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address" class="form-control" id="address" required>{{ $customer->address }}</textarea>
                            </div>
